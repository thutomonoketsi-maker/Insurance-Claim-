...
urlpatterns = [
    ...
    path('dashboard/customer/policies/<int:policy_id>/pay/', views.customer_ozow_payment, name='customer_ozow_payment'),
    path('dashboard/customer/payments/<int:payment_id>/ozow/return/', views.ozow_payment_return, name='ozow_payment_return'),
    path('ozow/notify/', views.ozow_webhook, name='ozow_webhook'),
